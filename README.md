...
<p align="center">A progressive <a href="http://nodejs.org" target="_blank">Node.js</a> app made with <a href="http://nestjs.com/">NestJS</a>, an efficient and scalable server-side framework.</p>
<p align="center">
<a href="https://github.com/vlasscontreras/nestjs-course/actions/workflows/build.yml" target="_blank"><img src="https://github.com/vlasscontreras/nestjs-course/actions/workflows/build.yml/badge.svg" alt="Build Status" /></a>
